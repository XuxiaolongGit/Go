...
func TestConvertDerivedString(t *testing.T) {
	...
	output, err := go_sql_driver.converter{}.ConvertValue(derived("value"))
	if err != nil {
...
func TestConvertDerivedUnsupportedSlice(t *testing.T) {
	...
	_, err := go_sql_driver.converter{}.ConvertValue(derived{1})
...
func TestConvertDerivedBool(t *testing.T) {
	...
	output, err := go_sql_driver.converter{}.ConvertValue(derived(true))
	if err != nil {
...
func TestConvertPointer(t *testing.T) {
	...
	output, err := go_sql_driver.converter{}.ConvertValue(&str)
	if err != nil {
...
func TestConvertSignedIntegers(t *testing.T) {
	...
	for _, value := range values {
		output, err := go_sql_driver.converter{}.ConvertValue(value)
		if err != nil {
...
func TestConvertUnsignedIntegers(t *testing.T) {
	...
	output, err := go_sql_driver.converter{}.ConvertValue(^uint64(0))
	if err != nil {
