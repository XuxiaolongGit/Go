...
var (
	_ driver.Rows = &go_sql_driver.binaryRows{}
	_ driver.Rows = &go_sql_driver.textRows{}
)
...
func runTestsWithMultiStatement(t *testing.T, dsn string, tests ...func(dbt *DBTest)) {
	...
	var db *sql.DB
	if _, err := go_sql_driver.ParseDSN(dsn); err != go_sql_driver.errInvalidDSNUnsafeCollation {
...
func runTests(t *testing.T, dsn string, tests ...func(dbt *DBTest)) {
	...
	var db2 *sql.DB
	if _, err := go_sql_driver.ParseDSN(dsn2); err != go_sql_driver.errInvalidDSNUnsafeCollation {
	...
	var db3 *sql.DB
	if _, err := go_sql_driver.ParseDSN(dsn3); err != go_sql_driver.errInvalidDSNUnsafeCollation {
...
func maybeSkip(t *testing.T, err error, skipErrno uint16) {
	mySQLErr, ok := err.(*go_sql_driver.MySQLError)
	if !ok {
		return
	}
...
func TestLoadData(t *testing.T) {
	runTests(t, dsn, func(dbt *DBTest) {
		...
		go_sql_driver.RegisterLocalFile(file.Name())
		...
		// Reader
		go_sql_driver.RegisterReaderHandler("test", func() io.Reader {
...
func TestTLS(t *testing.T) {
	...
	go_sql_driver.RegisterTLSConfig("custom-skip-verify", &tls.Config{
...
func TestRawBytesResultExceedsBuffer(t *testing.T) {
	runTests(t, dsn, func(dbt *DBTest) {
		...
		expected := strings.Repeat("abc", go_sql_driver.defaultBufSize)
...
func TestConcurrent(t *testing.T) {
	if enabled, _ := go_sql_driver.readBool(os.Getenv("MYSQL_TEST_CONCURRENT")); !enabled {
...
func TestCustomDial(t *testing.T) {
	...
	go_sql_driver.RegisterDial("mydial", func(addr string) (net.Conn, error) {
...
func TestUnixSocketAuthFail(t *testing.T) {
	runTests(t, dsn, func(dbt *DBTest) {
		...
		oldLogger := go_sql_driver.errLog

		// Set a new logger so we can capture its output.
		buffer := bytes.NewBuffer(make([]byte, 0, 64))
		newLogger := log.New(buffer, "prefix: ", 0)
		go_sql_driver.SetLogger(newLogger)

		// Restore the logger.
		defer go_sql_driver.SetLogger(oldLogger)
...
func TestColumnsReusesSlice(t *testing.T) {
	rows := go_sql_driver.mysqlRows{
		rs: go_sql_driver.resultSet{
			columns: []go_sql_driver.mysqlField{
				{
					tableName: "test",
					name:      "A",
				},
...
var (
	_ driver.ConnBeginTx        = &go_sql_driver.mysqlConn{}
	_ driver.ConnPrepareContext = &go_sql_driver.mysqlConn{}
	_ driver.ExecerContext      = &go_sql_driver.mysqlConn{}
	_ driver.Pinger             = &go_sql_driver.mysqlConn{}
	_ driver.QueryerContext     = &go_sql_driver.mysqlConn{}
)

// static interface implementation checks of mysqlStmt
var (
	_ driver.StmtExecContext  = &go_sql_driver.mysqlStmt{}
	_ driver.StmtQueryContext = &go_sql_driver.mysqlStmt{}
)
...
var (
	...
	_ driver.RowsColumnTypeDatabaseTypeName = &go_sql_driver.binaryRows{}
	_ driver.RowsColumnTypeDatabaseTypeName = &go_sql_driver.textRows{}
	_ driver.RowsColumnTypeNullable         = &go_sql_driver.binaryRows{}
	_ driver.RowsColumnTypeNullable         = &go_sql_driver.textRows{}
	_ driver.RowsColumnTypePrecisionScale   = &go_sql_driver.binaryRows{}
	_ driver.RowsColumnTypePrecisionScale   = &go_sql_driver.textRows{}
	_ driver.RowsColumnTypeScanType         = &go_sql_driver.binaryRows{}
	_ driver.RowsColumnTypeScanType         = &go_sql_driver.textRows{}
	_ driver.RowsNextResultSet              = &go_sql_driver.binaryRows{}
	_ driver.RowsNextResultSet              = &go_sql_driver.textRows{}
)
...
func TestContextBeginReadOnly(t *testing.T) {
	runTests(t, dsn, func(dbt *DBTest) {
		...
		if _, ok := err.(*go_sql_driver.MySQLError); ok {
...
func TestRowsColumnTypes(t *testing.T) {
	...
	nt0 := go_sql_driver.NullTime{Time: time.Date(2006, 01, 02, 15, 04, 05, 0, time.UTC), Valid: true}
	nt1 := go_sql_driver.NullTime{Time: time.Date(2006, 01, 02, 15, 04, 05, 100000000, time.UTC), Valid: true}
	nt2 := go_sql_driver.NullTime{Time: time.Date(2006, 01, 02, 15, 04, 05, 110000000, time.UTC), Valid: true}
	nt6 := go_sql_driver.NullTime{Time: time.Date(2006, 01, 02, 15, 04, 05, 111111000, time.UTC), Valid: true}
	nd1 := go_sql_driver.NullTime{Time: time.Date(2006, 01, 02, 0, 0, 0, 0, time.UTC), Valid: true}
	nd2 := go_sql_driver.NullTime{Time: time.Date(2006, 03, 04, 0, 0, 0, 0, time.UTC), Valid: true}
	ndNULL := go_sql_driver.NullTime{Time: time.Time{}, Valid: false}
	...
	var columns = []struct {
		...
		{"bit8null", "BIT(8)", "BIT", go_sql_driver.scanTypeRawBytes, true, 0, 0, [3]string{"0x0", "NULL", "0x42"}, [3]interface{}{rbx0, rbNULL, rbx42}},
		{"boolnull", "BOOL", "TINYINT", go_sql_driver.scanTypeNullInt, true, 0, 0, [3]string{"NULL", "true", "0"}, [3]interface{}{niNULL, ni1, ni0}},
		{"bool", "BOOL NOT NULL", "TINYINT", go_sql_driver.scanTypeInt8, false, 0, 0, [3]string{"1", "0", "FALSE"}, [3]interface{}{int8(1), int8(0), int8(0)}},
		{"intnull", "INTEGER", "INT", go_sql_driver.scanTypeNullInt, true, 0, 0, [3]string{"0", "NULL", "42"}, [3]interface{}{ni0, niNULL, ni42}},
		{"smallint", "SMALLINT NOT NULL", "SMALLINT", go_sql_driver.scanTypeInt16, false, 0, 0, [3]string{"0", "-32768", "32767"}, [3]interface{}{int16(0), int16(-32768), int16(32767)}},
		{"smallintnull", "SMALLINT", "SMALLINT", go_sql_driver.scanTypeNullInt, true, 0, 0, [3]string{"0", "NULL", "42"}, [3]interface{}{ni0, niNULL, ni42}},
		{"int3null", "INT(3)", "INT", go_sql_driver.scanTypeNullInt, true, 0, 0, [3]string{"0", "NULL", "42"}, [3]interface{}{ni0, niNULL, ni42}},
		{"int7", "INT(7) NOT NULL", "INT", go_sql_driver.scanTypeInt32, false, 0, 0, [3]string{"0", "-1337", "42"}, [3]interface{}{int32(0), int32(-1337), int32(42)}},
		{"mediumintnull", "MEDIUMINT", "MEDIUMINT", go_sql_driver.scanTypeNullInt, true, 0, 0, [3]string{"0", "42", "NULL"}, [3]interface{}{ni0, ni42, niNULL}},
		{"bigint", "BIGINT NOT NULL", "BIGINT", go_sql_driver.scanTypeInt64, false, 0, 0, [3]string{"0", "65535", "-42"}, [3]interface{}{int64(0), int64(65535), int64(-42)}},
		{"bigintnull", "BIGINT", "BIGINT", go_sql_driver.scanTypeNullInt, true, 0, 0, [3]string{"NULL", "1", "42"}, [3]interface{}{niNULL, ni1, ni42}},
		{"tinyuint", "TINYINT UNSIGNED NOT NULL", "TINYINT", go_sql_driver.scanTypeUint8, false, 0, 0, [3]string{"0", "255", "42"}, [3]interface{}{uint8(0), uint8(255), uint8(42)}},
		{"smalluint", "SMALLINT UNSIGNED NOT NULL", "SMALLINT", go_sql_driver.scanTypeUint16, false, 0, 0, [3]string{"0", "65535", "42"}, [3]interface{}{uint16(0), uint16(65535), uint16(42)}},
		{"biguint", "BIGINT UNSIGNED NOT NULL", "BIGINT", go_sql_driver.scanTypeUint64, false, 0, 0, [3]string{"0", "65535", "42"}, [3]interface{}{uint64(0), uint64(65535), uint64(42)}},
		{"uint13", "INT(13) UNSIGNED NOT NULL", "INT", go_sql_driver.scanTypeUint32, false, 0, 0, [3]string{"0", "1337", "42"}, [3]interface{}{uint32(0), uint32(1337), uint32(42)}},
		{"float", "FLOAT NOT NULL", "FLOAT", go_sql_driver.scanTypeFloat32, false, math.MaxInt64, math.MaxInt64, [3]string{"0", "42", "13.37"}, [3]interface{}{float32(0), float32(42), float32(13.37)}},
		{"floatnull", "FLOAT", "FLOAT", go_sql_driver.scanTypeNullFloat, true, math.MaxInt64, math.MaxInt64, [3]string{"0", "NULL", "13.37"}, [3]interface{}{nf0, nfNULL, nf1337}},
		{"float74null", "FLOAT(7,4)", "FLOAT", go_sql_driver.scanTypeNullFloat, true, math.MaxInt64, 4, [3]string{"0", "NULL", "13.37"}, [3]interface{}{nf0, nfNULL, nf1337}},
		{"double", "DOUBLE NOT NULL", "DOUBLE", go_sql_driver.scanTypeFloat64, false, math.MaxInt64, math.MaxInt64, [3]string{"0", "42", "13.37"}, [3]interface{}{float64(0), float64(42), float64(13.37)}},
		{"doublenull", "DOUBLE", "DOUBLE", go_sql_driver.scanTypeNullFloat, true, math.MaxInt64, math.MaxInt64, [3]string{"0", "NULL", "13.37"}, [3]interface{}{nf0, nfNULL, nf1337}},
		{"decimal1", "DECIMAL(10,6) NOT NULL", "DECIMAL", go_sql_driver.scanTypeRawBytes, false, 10, 6, [3]string{"0", "13.37", "1234.123456"}, [3]interface{}{sql.RawBytes("0.000000"), sql.RawBytes("13.370000"), sql.RawBytes("1234.123456")}},
		{"decimal1null", "DECIMAL(10,6)", "DECIMAL", go_sql_driver.scanTypeRawBytes, true, 10, 6, [3]string{"0", "NULL", "1234.123456"}, [3]interface{}{sql.RawBytes("0.000000"), rbNULL, sql.RawBytes("1234.123456")}},
		{"decimal2", "DECIMAL(8,4) NOT NULL", "DECIMAL", go_sql_driver.scanTypeRawBytes, false, 8, 4, [3]string{"0", "13.37", "1234.123456"}, [3]interface{}{sql.RawBytes("0.0000"), sql.RawBytes("13.3700"), sql.RawBytes("1234.1235")}},
		{"decimal2null", "DECIMAL(8,4)", "DECIMAL", go_sql_driver.scanTypeRawBytes, true, 8, 4, [3]string{"0", "NULL", "1234.123456"}, [3]interface{}{sql.RawBytes("0.0000"), rbNULL, sql.RawBytes("1234.1235")}},
		{"decimal3", "DECIMAL(5,0) NOT NULL", "DECIMAL", go_sql_driver.scanTypeRawBytes, false, 5, 0, [3]string{"0", "13.37", "-12345.123456"}, [3]interface{}{rb0, sql.RawBytes("13"), sql.RawBytes("-12345")}},
		{"decimal3null", "DECIMAL(5,0)", "DECIMAL", go_sql_driver.scanTypeRawBytes, true, 5, 0, [3]string{"0", "NULL", "-12345.123456"}, [3]interface{}{rb0, rbNULL, sql.RawBytes("-12345")}},
		{"char25null", "CHAR(25)", "CHAR", go_sql_driver.scanTypeRawBytes, true, 0, 0, [3]string{"0", "NULL", "'Test'"}, [3]interface{}{rb0, rbNULL, rbTest}},
		{"varchar42", "VARCHAR(42) NOT NULL", "VARCHAR", go_sql_driver.scanTypeRawBytes, false, 0, 0, [3]string{"0", "'Test'", "42"}, [3]interface{}{rb0, rbTest, rb42}},
		{"binary4null", "BINARY(4)", "BINARY", go_sql_driver.scanTypeRawBytes, true, 0, 0, [3]string{"0", "NULL", "'Test'"}, [3]interface{}{rb0pad4, rbNULL, rbTest}},
		{"varbinary42", "VARBINARY(42) NOT NULL", "VARBINARY", go_sql_driver.scanTypeRawBytes, false, 0, 0, [3]string{"0", "'Test'", "42"}, [3]interface{}{rb0, rbTest, rb42}},
		{"tinyblobnull", "TINYBLOB", "BLOB", go_sql_driver.scanTypeRawBytes, true, 0, 0, [3]string{"0", "NULL", "'Test'"}, [3]interface{}{rb0, rbNULL, rbTest}},
		{"tinytextnull", "TINYTEXT", "TEXT", go_sql_driver.scanTypeRawBytes, true, 0, 0, [3]string{"0", "NULL", "'Test'"}, [3]interface{}{rb0, rbNULL, rbTest}},
		{"blobnull", "BLOB", "BLOB", go_sql_driver.scanTypeRawBytes, true, 0, 0, [3]string{"0", "NULL", "'Test'"}, [3]interface{}{rb0, rbNULL, rbTest}},
		{"textnull", "TEXT", "TEXT", go_sql_driver.scanTypeRawBytes, true, 0, 0, [3]string{"0", "NULL", "'Test'"}, [3]interface{}{rb0, rbNULL, rbTest}},
		{"mediumblob", "MEDIUMBLOB NOT NULL", "BLOB", go_sql_driver.scanTypeRawBytes, false, 0, 0, [3]string{"0", "'Test'", "42"}, [3]interface{}{rb0, rbTest, rb42}},
		{"mediumtext", "MEDIUMTEXT NOT NULL", "TEXT", go_sql_driver.scanTypeRawBytes, false, 0, 0, [3]string{"0", "'Test'", "42"}, [3]interface{}{rb0, rbTest, rb42}},
		{"longblob", "LONGBLOB NOT NULL", "BLOB", go_sql_driver.scanTypeRawBytes, false, 0, 0, [3]string{"0", "'Test'", "42"}, [3]interface{}{rb0, rbTest, rb42}},
		{"longtext", "LONGTEXT NOT NULL", "TEXT", go_sql_driver.scanTypeRawBytes, false, 0, 0, [3]string{"0", "'Test'", "42"}, [3]interface{}{rb0, rbTest, rb42}},
		{"datetime", "DATETIME", "DATETIME", go_sql_driver.scanTypeNullTime, true, 0, 0, [3]string{"'2006-01-02 15:04:05'", "'2006-01-02 15:04:05.1'", "'2006-01-02 15:04:05.111111'"}, [3]interface{}{nt0, nt0, nt0}},
		{"datetime2", "DATETIME(2)", "DATETIME", go_sql_driver.scanTypeNullTime, true, 2, 2, [3]string{"'2006-01-02 15:04:05'", "'2006-01-02 15:04:05.1'", "'2006-01-02 15:04:05.111111'"}, [3]interface{}{nt0, nt1, nt2}},
		{"datetime6", "DATETIME(6)", "DATETIME", go_sql_driver.scanTypeNullTime, true, 6, 6, [3]string{"'2006-01-02 15:04:05'", "'2006-01-02 15:04:05.1'", "'2006-01-02 15:04:05.111111'"}, [3]interface{}{nt0, nt1, nt6}},
		{"date", "DATE", "DATE", go_sql_driver.scanTypeNullTime, true, 0, 0, [3]string{"'2006-01-02'", "NULL", "'2006-03-04'"}, [3]interface{}{nd1, ndNULL, nd2}},
		{"year", "YEAR NOT NULL", "YEAR", go_sql_driver.scanTypeUint16, false, 0, 0, [3]string{"2006", "2000", "1994"}, [3]interface{}{uint16(2006), uint16(2000), uint16(1994)}},
	}
			...
			for rows.Next() {
				...
				for j := range values {
					...
					if !reflect.DeepEqual(value, columns[j].valuesOut[i]) {
						if columns[j].scanType == go_sql_driver.scanTypeRawBytes {
